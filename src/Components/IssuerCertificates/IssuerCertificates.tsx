    ...
    useEffect(() => {
        const fetchCertificates = async () => {
            ...
            try {
                setLoading(true);
                setError(null);
                const ids = await getIssuerCertificates(address);
                ...
                console.error("Failed to fetch Issuer certificates:", err);
    ...
    return (
        <div className="max-w-4xl mx-auto my-8 p-6 bg-surface rounded-lg shadow-lg text-text">
            ...
            {loading ? (
                ...
                <div className="text-center py-10 text-text-secondary">
                    <p className="text-lg">No certificates issued from your address yet.</p>
                </div>
            ) : (
