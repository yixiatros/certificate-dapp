...
import { FaCertificate, FaHome, FaList, FaUsers } from 'react-icons/fa'
...
const AuditorSidebar = (props: Props) => {
  return (
    <Sidebar>
      ...
      <Link to="Event Log" className="md:min-w-full text-text-secondary-500 text-medium uppercase font-bold flex items-center pt-1 pb-4 no-underline">
        <FaList />
        <h6 className='ml-3'>Event Log</h6>
      </Link>
    </Sidebar>
  )
}
